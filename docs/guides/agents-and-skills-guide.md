...
A complete reference for the five specialist agents, 11 slash commands and the `/adversarial-review` skill designed for this template. Covers what each agent does, how they work together in sequence, practical usage examples, and how to maintain and extend the system over time.
...
| 7 | **Orchestration** | ✅ Present | `.claude/commands/` (11 slash commands) + `.claude/skills/adversarial-review/` (routing to agents + skills), Dev Lead as the only agent with the Agent tool (correct orchestrator pattern), `CLAUDE.md` routing table |
...
+-------------------------------------------------------------+
|  The project surface: 11 commands + /adversarial-review         |
|                                                              |
...
|  Review:     /adversarial-review  (skill, not command)           |
+-------------------------------------------------------------+
...
> **The surface of this project, in full:**
>
> Eleven commands in `.claude/commands/`: `/dev-lead`, `/gate`, `/new-feature`,
> `/new-api`, `/new-component`, `/code-review`, `/run-tests`, `/security-audit`,
> `/infra-check`, `/research`, `/write-adr`.
>
> One skill in `.claude/skills/`: `/adversarial-review` — adversarial review of any
> artifact in this repository.
>
> Five agents in `.claude/agents/`, spawned by the pipelines, never invoked
> directly by name.
>
> Nothing outside this repository is required or invoked.
>
